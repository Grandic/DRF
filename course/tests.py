...
class LessonsTestCase(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.client.credentials(HTTTP_AUTHORIZATION=f'Bearer {self.access_token}')
    ...
    def test_create_subscription(self):
            print(f'{self.user.__str__()} {self.access_token}')

            # subscription = {'course': self.course.pk}
            #
            # print(self.course.owner)
            ...
            # self.assertEqual(response.json()['subscription'], True)
