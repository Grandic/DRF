...
from lesson.views import LessonCreateAPIView, LessonListAPIView, LessonRetrieveAPIView, LessonUpdateAPIView, LessonDestroyAPIView
...
urlpatterns = [
    ...
    path('delete/<int:pk>/', LessonDestroyAPIView.as_view(), name='delete-update'),
]
